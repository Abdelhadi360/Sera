...
export default function Home() {
  ...
  return (
    ...
    />
      ...
      <Header />
      <div className="p-4">
          <h1 className='text-3xl sm:text-5xl font-bold w-full sm:w-2/3'>An AI Chat Companion That Understands You.</h1>
          <div className="flex justify-center items-center h-64 sm:px-10">
              <div className="flex flex-col gap-2 p-2 overflow-hidden bg-gray-100 w-full max-w-[50rem] text-gray-800 rounded duration-100 hover:shadow-2xl">
                  ...
                  <Link to={isLoggedIn ? "/chat" : "/signup"} className='flex items-center justify-center self-end h-full' >
